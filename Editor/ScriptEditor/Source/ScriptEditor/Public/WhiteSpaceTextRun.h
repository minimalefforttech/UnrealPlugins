...
// Copied from Engine\Plugins\Experimental\CodeEditor\Source\CodeEditor\Private\WhiteSpaceTextRun.h
...
{
public:
	static TSharedRef< FWhiteSpaceTextRun > Create( const FRunInfo& InRunInfo,
...
public:
	virtual FVector2D Measure( int32 StartIndex,
	                           int32 EndIndex,
							   float Scale,
							   const FRunTextContext& TextContext ) const override;

protected:
	FWhiteSpaceTextRun( const FRunInfo& InRunInfo,
	                    const TSharedRef< const FString >& InText,
